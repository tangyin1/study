...
module.exports = {
	...
	port: 8360, //服务端口，可自定义
    weixin: {
        appid: 'wxb58d25a53c4fbe5d', // 小程序 appid
        secret: 'ab9017bd50230cb61104ca0c9469b260', // 小程序密钥
   ...
   mianexpress:{
    ...
    qiniu: {
        access_key: 'LUq0ziVr6P0LQA1HJr61GmL429HsIHs5dSkzaybW',      // 在七牛密钥管理中获取
        secret_key: 'v9oujv5SzGeTfaV9yL8U-Jn7GZvf4LdZxkFl9EUz',    // 在七牛密钥管理中获取
        bucket: 'tangyin',                    // 请填自己的bucket的名称
        domain: 'http://sc2io9csr.hn-bkt.clouddn.com/'                         // 请填自己的domain域名
    },
