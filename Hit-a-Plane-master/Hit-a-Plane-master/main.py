...
def showmenu():
	...
	font_path = "C:\\Users\\LENOVO\\PycharmProjects\\jerkoff-master\\jerkoff-master\\src\\gamefont.ttf" # 字体文件路径
	font = pygame.font.Font(font_path, 36)
	text = font.render("游戏规则：", True, (255, 255, 255))
	screen.blit(text, (50, 50))

	font = pygame.font.Font(font_path, 24)
	text1 = font.render("你控制一架战斗机穿行在滚动的太空中。", True,
	(255, 255, 255))
	text2=font.render("你的任务是躲避并摧毁它们。", True, (255, 255, 255))
	text3 = font.render("按空格键使用炸药包，炸药包上限三个", True, (255, 255, 255))
	text4 = font.render("使用方向键控制飞机移动", True, (255, 255, 255))
	screen.blit(text1, (50, 100))
	screen.blit(text2, (50, 130))
	screen.blit(text3, (50, 160))
	screen.blit(text4, (50, 190))
	font = pygame.font.Font(font_path, 28)
	text5 = font.render("上吧战士们！gogogo", True, (255, 255, 255))
	screen.blit(text5, (120, screen.get_height() - 300))
	text = font.render("按任意键开始游戏", True, (255, 255, 255))
	screen.blit(text, (120, screen.get_height() - 100))
...
def show1():
	...
	font = pygame.font.Font(font_path, 24)
	text1 = font.render("小试牛刀", True,
						(255, 255, 255))
	text2 = font.render("接下来进入第二关", True, (255, 255, 255))
...
def show2():
	...
	text1 = font.render("warning！warning！", True,
						(205,51,51))
	#text2 = font.render("接下来进入第二关", True, (255, 255, 255))
	text3 = font1.render("难度骤升！!",True, (205,51,51))
	screen.blit(text1, (60, 100))
	#screen.blit(text2, (120, 170))
	screen.blit(text3, (30, 250))
	pygame.display.flip()
	# 等待用户按下某个键，然后返回
	while True:
		for event in pygame.event.get():
...
def check_cheat(event):
    ...
    if keys_pressed[K_UP] and keys_pressed[K_UP] and keys_pressed[K_DOWN] and keys_pressed[K_DOWN] and keys_pressed[K_LEFT] and keys_pressed[K_LEFT] and keys_pressed[K_RIGHT] and keys_pressed[K_RIGHT]:
        return True
    return False
   ...
   #开挂
	...
	while running:
		...
		if level == 1 and score > 5000:
			...
			add_big_enemies(big_enemies,enemies,7)
			#提升小型敌机速度
			inc_speed(small_enemies,10)
