...
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '学生考试表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `s_student_option`  (
  ...
  `abc` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'abc的序号',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `s_student_question`  (
  ...
  `answer` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '回答',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1152 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '学生答题表' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'admin', 0, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/16516750320401.jpeg');
INSERT INTO `sys_user` VALUES (2, 'gaocheng', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/16516750391632.jpeg');
INSERT INTO `sys_user` VALUES (3, '张三', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/16516751582683.jpeg');
INSERT INTO `sys_user` VALUES (4, '李四', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/16516753907524.jpeg');
INSERT INTO `sys_user` VALUES (5, '王五', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/16516754804065.jpeg');
INSERT INTO `sys_user` VALUES (6, '机器猫', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/16516755166346.jpeg');
INSERT INTO `sys_user` VALUES (7, '汤姆猫', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/16516755208997.jpeg');
INSERT INTO `sys_user` VALUES (8, '杰瑞鼠', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/16516755257138.jpeg');
INSERT INTO `sys_user` VALUES (9, '江流儿', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/16516755303939.jpeg');
INSERT INTO `sys_user` VALUES (10, '哪吒', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/165167553452910.jpeg');
INSERT INTO `sys_user` VALUES (11, '小男孩', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/165167554020911.jpeg');
INSERT INTO `sys_user` VALUES (12, '小女孩', '123456', 1, 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/165167554428112.jpeg');
...
CREATE TABLE `t_chapter`  (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '章节名',
...
) ENGINE = InnoDB AUTO_INCREMENT = 57 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '章节表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_exam`  (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '考试名称',
  ...
  `notice` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '考前注意事项',
  `privilege` tinyint(4) NOT NULL COMMENT '考试权限',
  `password` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '考试密码',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_t_exam_t_paper_1`(`paper_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '考试表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_option`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `question_id` int(11) NOT NULL COMMENT '题目id',
  `content` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '答案内容',
...
) ENGINE = InnoDB AUTO_INCREMENT = 771 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '题目选项表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_paper`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '试卷表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 310 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '试卷题目表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_question`  (
  ...
  `content` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '题目内容',
  `image` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '题目图片',
  `answer` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '答案',
  `answer_image` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '答案图片',
  `analysis` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分析',
  `analysis_image` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分析图片',
...
) ENGINE = InnoDB AUTO_INCREMENT = 109 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '题目表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_question` VALUES (2, 1, 48, 0, '中国历史上在位时间最长的皇帝是谁？', 'https://gaocheng-imgsubmit.oss-cn-hangzhou.aliyuncs.com/Exam/pictures/16516787865661.jpeg', '747', NULL, '康熙皇帝在位62年，乾隆皇帝在位60年，汉武帝在位54年，万历皇帝在位48年，唐玄宗在位44年。', NULL, NULL, '2022-04-13 12:43:10', '2022-05-04 23:39:49');
...
CREATE TABLE `t_repo`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '题库名称',
  `sigle_count` int(11) NOT NULL DEFAULT 0 COMMENT '单选题数量',
  `multi_count` int(11) NOT NULL DEFAULT 0 COMMENT '多选题数量',
  `judge_count` int(11) NOT NULL DEFAULT 0 COMMENT '判断题数量',
  `blank_count` int(11) NOT NULL DEFAULT 0 COMMENT '填空题数量',
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '课程表' ROW_FORMAT = DYNAMIC;
